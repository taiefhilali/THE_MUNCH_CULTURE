...
void MainWindow::on_pushButton_1_clicked()  //ajouter depense
{
...
void MainWindow::on_pushButton_2_clicked()  //modifier depense
{
    {
        int id_dep,tot_dep;
...
void MainWindow::on_modifier3_2_clicked() //modifier produit
{
    {
...
void MainWindow::on_pushButton_7_clicked()  //rechercher depense
{
    QSqlQueryModel *modal=new QSqlQueryModel();
                QSqlQuery request;
...
void MainWindow::on_EXCEL_4_clicked()
{ QTableView *table;
    table = ui->tab_dep;
    QString filters("mdb files (*.csv);;All files (*.*)");
    QString defaultFilter("mdb files (*.csv)");
