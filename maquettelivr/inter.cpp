...
void inter::on_ajouter1_clicked()
{
...
void inter::on_supprimer_2_clicked()
{
...
void inter::on_modifier3_clicked()
{
...
void inter::on_supprimer_clicked()
...
void inter::on_commandLinkButton_clicked()
{
...
void inter::on_colone_tri_activated(const QString &arg1)
{
...
void inter::on_commandLinkButton_2_clicked()
{
    QSqlQueryModel *modal=new QSqlQueryModel();
            QSqlQuery request;
...
void inter::on_pushButton_4_clicked()
{
     ui->tab_liv_2->setModel(l.afficher());
     son->play();
     son=new QSound(":/click.wav");
...
void inter::on_colone_tri_2_activated(const QString &arg1)
{
    QString type=arg1;
      QString val=ui->le_recherche->text();
      val="%"+val+"%";
...
void inter::on_modifier_2_clicked()
{
...
void inter::on_imprimer_2_clicked()
{
    QString strStream;
               QTextStream out(&strStream);
               const int rowCount = ui->tab_liv_2->model()->rowCount();
...
void inter::on_imprimer_clicked()
{
    QString strStream;
                QTextStream out(&strStream);
                const int rowCount = ui->tab_livr->model()->rowCount();
...
void inter::on_pushButton_5_clicked()
{
    int col = ui->tab_livr->currentIndex().column();
           int row = ui->tab_livr->currentIndex().row();
           QString sql;
