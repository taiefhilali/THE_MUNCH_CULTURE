...
void youssef::on_ajouter1_clicked()
    {int i=0;
        ...
        QString date_produit=ui->dattes->text();
...
void youssef::on_pbResult_clicked()
{
    QMessageBox msgBox;
    int x=D.get_total();
    int y=R.get_total();
    ...
    if((y-x)>0){
         ui->res->setNum(y-x);
         QMessageBox::information(nullptr, QObject::tr("le compte est bon"),
                     QObject::tr("c'est bon"
                                 "(revenu>depense)."), QMessageBox::Cancel);

    }else{
         ui->res->setNum(y-x);
         QMessageBox::information(nullptr, QObject::tr("ERREUR"),
                     QObject::tr("MAUVAIS CHOIX"
                                 "(revenu<depense)."), QMessageBox::Cancel);

    }
}

void youssef::on_total_clicked()
{
